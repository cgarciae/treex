...
Tensor = jnp.ndarray
tensor = jnp.array
from treex.metrics.tm_port.functional.classification.stat_scores import (
    _stat_scores_compute,
    _stat_scores_update,
)
from treex.metrics.tm_port.metric import Metric
...
class StatScores(Metric):
    ...
    """
    tp: Union[Tensor, List[Tensor]] = types.MetricState.node()
    fp: Union[Tensor, List[Tensor]] = types.MetricState.node()
    tn: Union[Tensor, List[Tensor]] = types.MetricState.node()
    fn: Union[Tensor, List[Tensor]] = types.MetricState.node()
